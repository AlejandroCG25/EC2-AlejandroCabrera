...
import com.alejandro.ec2_alejandrocabrera.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnIngresar.setOnClickListener {
            Toast.makeText(applicationContext, "Bienvenido a MarketMingle!!",Toast.LENGTH_LONG).show()
